...
import ChallengeDetailModal from "../../component/ChallengeDetailModal.jsx";
    ...
    const openChallengeDetail = (challenge) => {
        ...
        setTimeout(() => {
            const challengeDetails = {
                ...challenge,
                description: challenge.description || 'This challenge aims to improve health and endurance through consistent training.',
                ...
                <div className="flex-1 overflow-auto p-4">
                    <div
                        ...
                        <div className="p-4 border-b border-orange-100 bg-gradient-to-r from-orange-50 to-yellow-50">
                            <h1 className="text-2xl font-bold text-orange-600 mb-4">Quản lý thử thách</h1>
                            <div className="flex flex-col md:flex-row gap-3 justify-between">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <span>{filterStatus ? `Trạng thái: ${filterStatus}` : 'Lọc theo trạng thái'}</span>
                                    ...
                                    {currentChallenges.length === 0 ? (
                                        ...
                                        currentChallenges.map((challenge) => (
                                            <tr key={challenge.id}
                                                ...
                                                <td className="p-4 hidden md:table-cell text-gray-600">{challenge.description}</td>
                                                <td className="p-4">
                                                    {challenge.status === "rejected" || challenge.status === "inactive" ? (
                                                        <div className="flex items-center text-red-500">
                                                            <XCircle className="mr-2 h-5 w-5" />
                                                            <span className="text-sm font-medium">
                                                                {challenge.status === "rejected" ? "Đã từ chối" : "Không hoạt động"}
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center text-green-500">
                                                            ...
                                                            <span className="text-sm font-medium">
                                                                {challenge.status === "accepted" ? "Đã chấp nhận" : "Hoạt động"}
                                                            </span>
                                                        </div>
                                                    )}
                                                </td>
                                                <td className="p-4">
                                                    <div className="flex space-x-2">
                                                        {challenge.status === "waiting" ? (
                                                            ...
                                                            <button
                                                                className={`p-2 ${challenge.status === "accepted" ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"} rounded-md hover:${challenge.status === "accepted" ? "bg-red-200" : "bg-green-200"} transition-colors`}
                        ...
                        <div
                            ...
                            <div className="text-gray-600">
                                Hiển thị <span
                                className="font-medium">{currentChallenges.length > 0 ? indexOfFirstChallenge + 1 : 0}</span> đến <span
                                className="font-medium">{indexOfFirstChallenge + currentChallenges.length}</span> trong
                                tổng số <span className="font-medium">{challenges.length}</span> thử thách
                            </div>
